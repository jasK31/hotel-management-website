					...
					<form action="index.php?page=list" id="filter" method="POST">
						<div class="row">
							<div class="col-md-5">
								...
								<input type="text" class="form-control datepicker  m-4" name="date_in" autocomplete="off" value="<?php echo isset($date_in) ? date("Y-m-d", strtotime($date_in)) : "" ?>">
							</div>
							<div class="col-md-5">
								<label for="">Checkout Date</label>
								<input type="text" class="form-control datepicker  m-4" name="date_out" autocomplete="off" value="<?php echo isset($date_out) ? date("Y-m-d", strtotime($date_out)) : "" ?>">
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-3 text-center">
								<div class="dropdown  m-4">
									<button class="btn btn-light w-100 dropdown-toggle" type="button" data-toggle="dropdown"> Adults
							...
							<div class="col-md-3 text-center">
								<div class="dropdown  m-4">
									<button class="btn btn-light w-100 dropdown-toggle" type="button" data-toggle="dropdown">Children
										<span class="caret"></span></button>
							...
							<div class="col-md-3">
								<div class="dropdown  m-4">
									<button class="btn btn-light dropdown-toggle" type="button" data-toggle="dropdown">No. of Rooms
										<span class="caret"></span></button>
									<select class="dropdown-menu">
										<option>HTML</option>
										<option>HTML</option>
						...
						<div class="row">
							...
							<div class="col-md-5" height="100%">
								...
								<div class="align-self-end mt-5">
									<button class="btn btn-secondary m-5  float-right book_now" type="button" data-id="<?php echo $row['category_id'] ?>">Book now</button>
								</div>
							</div>
						</div>
